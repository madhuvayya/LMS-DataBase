...
-- sql query to create temp_user_engagement_mis table

CREATE TABLE `temp_user_engagement_mis` (
  `date_time` datetime DEFAULT NULL,
  `cpu_count` tinyint DEFAULT NULL,
  `cpu_working_time` decimal(10,2) DEFAULT NULL,
  `cpu_idle_time` decimal(10,2) DEFAULT NULL,
  `cpu_percent` decimal(5,2) DEFAULT NULL,
  `usage_cpu_count` tinyint unsigned DEFAULT NULL,
  `number_of_ software_ interrupts_since_boot` int unsigned DEFAULT NULL,
  `number_of_system_calls_since_boot` tinyint unsigned DEFAULT NULL,
  `number_of_interrupts_since_boot` int unsigned DEFAULT NULL,
  `cpu_avg_load_over_1_min` decimal(5,2) DEFAULT NULL,
  `cpu_avg_load_over_5_min` decimal(5,2) DEFAULT NULL,
  `cpu_avg_load_over_15_min` decimal(5,2) DEFAULT NULL,
  `system_total_memory` bigint unsigned DEFAULT NULL,
  `system_used_memory` bigint unsigned DEFAULT NULL,
  `system_free_memory` bigint unsigned DEFAULT NULL,
  `system_active_memory` bigint unsigned DEFAULT NULL,
  `system_inactive_memory` bigint unsigned DEFAULT NULL,
  `system_buffers_memory` bigint unsigned DEFAULT NULL,
  `system_cached_memory` bigint unsigned DEFAULT NULL,
  `system_shared_memory` bigint unsigned DEFAULT NULL,
  `system_avalible_memory` bigint DEFAULT NULL,
  `disk_total_memory` bigint DEFAULT NULL,
  `disk_used_memory` bigint DEFAULT NULL,
  `disk_free_memory` bigint DEFAULT NULL,
  `disk_read_count` int unsigned DEFAULT NULL,
  `disk_write_count` int unsigned DEFAULT NULL,
  `disk_read_bytes` bigint unsigned DEFAULT NULL,
  `disk_write_bytes` bigint unsigned DEFAULT NULL,
  `time_spent_reading_ from_disk` bigint unsigned DEFAULT NULL,
  `time_spent_writing_ to_disk` bigint unsigned DEFAULT NULL,
  `time_spent_doing_actual_I/Os` bigint unsigned DEFAULT NULL,
  `number_of_bytes_sent` bigint unsigned DEFAULT NULL,
  `number_of_bytes_received` bigint unsigned DEFAULT NULL,
  `number_of_packets_sent` bigint unsigned DEFAULT NULL,
  `number_of_packets_recived` bigint unsigned DEFAULT NULL,
  `total_number_of_errors_while_receiving` tinyint unsigned DEFAULT NULL,
  `total_number_of_errors_while_sending` tinyint unsigned DEFAULT NULL,
  `total_number_of_incoming_packets_which_were_dropped` tinyint unsigned DEFAULT NULL,
  `total_number_of_outgoing_packets_which_were_dropped` tinyint unsigned DEFAULT NULL,
  `boot_time` time DEFAULT NULL,
  `user_name` varchar(64) DEFAULT NULL,
  `keyboard` decimal(8,2) DEFAULT NULL,
  `mouse` smallint unsigned DEFAULT NULL,
  `technology` varchar(45) DEFAULT NULL,
  `files_changed` smallint unsigned DEFAULT NULL
);